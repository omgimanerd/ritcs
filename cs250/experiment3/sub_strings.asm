...
#
	...
	.globl  sub_ascii_numbers	# external function we call
...
problem1a:
	.word	str_a3, str_a4, buf_a2, 4, out_a2

problem1b:
	.word	str_a3, str_a5, buf_a2, 4, out_a2

problem1c:
	.word	str_a3, str_a6, buf_a2, 4, out_a2

problem2a:
	.word	str_b1, str_b2, buf_b, 10, out_b

problem2b:
	.word	str_b3, str_b2, buf_b, 10, out_b
...
#
# call the sub_ascii_numbers subroutine to do the subtraction.
# The address of the parameter block is in s0.
# doing this first, so that if they mess up the inputs, we will see
#

	move	$a0, $s0		# set up argument for function
	jal	sub_ascii_numbers
...
#
# Now, call the sub_ascii_numbers subroutine to do the subtraction.
# The address of the parameter block is still in s0.
#
