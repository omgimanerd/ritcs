...
public class TestLongestIncreasingSubseqDP extends TestSolution {
  ...
  public TestLongestIncreasingSubseqDP(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      LongestIncreasingSubseqDP.main(new String[1]);
