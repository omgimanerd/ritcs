...
public class TestCountIntervals extends TestSolution {

  public static final String DATA_PATH = "data/hw3/problem4";

  private File inFile;
  private File ansFile;

  public TestCountIntervals(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      CountIntervals.main(new String[1]);
