...
public class TestSortQuadraticElements extends TestSolution {

  public static final String DATA_PATH = "data/hw2/problem5";

  private File inFile;
  private File ansFile;

  public TestSortQuadraticElements(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      SortQuadraticElements.main(new String[1]);
