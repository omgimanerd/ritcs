...
public class TestWeightedInversions extends TestSolution {

  public static final String DATA_PATH = "data/hw2/problem3";

  private File inFile;
  private File ansFile;

  public TestWeightedInversions(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      WeightedInversions.main(new String[1]);
