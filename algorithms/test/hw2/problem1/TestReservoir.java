...
public class TestReservoir extends TestSolution {

  public static final String DATA_PATH = "data/hw2/problem1";

  private File inFile;
  private File ansFile;

  public TestReservoir(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
