...
public class TestSmallestTwo extends TestSolution {

  public static final String DATA_PATH = "data/hw0/problem2";

  private File inFile;
  private File ansFile;

  public TestSmallestTwo(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
