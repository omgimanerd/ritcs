...
public class TestSpanTree extends TestSolution {

  public static final String DATA_PATH = "data/hw5/problem4";

  private File inFile;
  private File ansFile;

  public TestSpanTree(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
