...
public class TestTriangulation extends TestSolution {

  public static final String DATA_PATH = "data/hw4/problem5";

  private File inFile;
  private File ansFile;

  public TestTriangulation(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      Triangulation.main(new String[1]);
