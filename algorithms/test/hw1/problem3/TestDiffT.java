...
public class TestDiffT extends TestSolution {

  public static final String DATA_PATH = "data/hw1/problem3";

  private File inFile;
  private File ansFile;

  public TestDiffT(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
