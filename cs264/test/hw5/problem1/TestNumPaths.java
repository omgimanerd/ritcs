...
public class TestNumPaths extends TestSolution {

  public static final String DATA_PATH = "data/hw5/problem1";

  private File inFile;
  private File ansFile;

  public TestNumPaths(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
