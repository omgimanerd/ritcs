...
public class TestOneWay extends TestSolution {

  public static final String DATA_PATH = "data/hw5/problem5";

  private File inFile;
  private File ansFile;

  public TestOneWay(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
