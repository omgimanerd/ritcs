...
public class TestPrerequisites extends TestSolution {

  public static final String DATA_PATH = "data/hw5/problem2";

  private File inFile;
  private File ansFile;

  public TestPrerequisites(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      Prerequisites.main(new String[1]);
