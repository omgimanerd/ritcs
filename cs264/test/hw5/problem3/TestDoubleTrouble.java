...
public class TestDoubleTrouble extends TestSolution {

  public static final String DATA_PATH = "data/hw5/problem3";

  private File inFile;
  private File ansFile;

  public TestDoubleTrouble(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      DoubleTrouble.main(new String[1]);
