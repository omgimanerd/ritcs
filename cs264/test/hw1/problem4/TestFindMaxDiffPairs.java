...
public class TestFindMaxDiffPairs extends TestSolution {

  public static final String DATA_PATH = "data/hw1/problem4";

  private File inFile;
  private File ansFile;

  public TestFindMaxDiffPairs(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      FindMaxDiffPairs.main(new String[1]);
