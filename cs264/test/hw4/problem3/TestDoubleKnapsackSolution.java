...
public class TestDoubleKnapsackSolution extends TestSolution {

  public static final String DATA_PATH = "data/hw4/problem3";

  private File inFile;
  private File ansFile;

  public TestDoubleKnapsackSolution(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      DoubleKnapsackSolution.main(new String[1]);
