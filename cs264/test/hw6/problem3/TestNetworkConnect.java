...
public class TestNetworkConnect extends TestSolution {

  public static final String DATA_PATH = "data/hw6/problem3";

  private File inFile;
  private File ansFile;

  public TestNetworkConnect(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      NetworkConnect.main(new String[1]);
