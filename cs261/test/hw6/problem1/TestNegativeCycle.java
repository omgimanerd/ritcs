...
public class TestNegativeCycle extends TestSolution {

  public static final String DATA_PATH = "data/hw6/problem1";

  private File inFile;
  private File ansFile;

  public TestNegativeCycle(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      NegativeCycle.main(new String[1]);
