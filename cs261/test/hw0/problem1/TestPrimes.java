...
public class TestPrimes extends TestSolution {

  public static final String DATA_PATH = "data/hw0/problem1";

  private File inFile;
  private File ansFile;

  public TestPrimes(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
