...
public class TestLongestIncreasingSubseqRecursive extends TestSolution {

  public static final String DATA_PATH = "data/hw3/problem2";

  private File inFile;
  private File ansFile;

  public TestLongestIncreasingSubseqRecursive(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      LongestIncreasingSubseqRecursive.main(new String[1]);
