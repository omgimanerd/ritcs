...
public class TestDonut extends TestSolution {

  public static final String DATA_PATH = "data/hw3/problem0";

  private File inFile;
  private File ansFile;

  public TestDonut(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
