...
public class TestLongestConvexSubseq extends TestSolution {

  public static final String DATA_PATH = "data/hw4/problem1";

  private File inFile;
  private File ansFile;

  public TestLongestConvexSubseq(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      LongestConvexSubseq.main(new String[1]);
