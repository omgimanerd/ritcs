...
public class TestDoubleKnapsack extends TestSolution {

  public static final String DATA_PATH = "data/hw4/problem2";

  private File inFile;
  private File ansFile;

  public TestDoubleKnapsack(File in, File ans) {
    this.inFile = in;
    this.ansFile = ans;
  }
  ...
  public void runTests() throws IOException {
    ...
    try (
      ...
      DoubleKnapsack.main(new String[1]);
